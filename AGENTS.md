...
4. **早间电台版（第一点五版，施工中）**：渐变底已定、左介绍为占位文案、右四图正方形占位「施工中」；待用户提供正式文案 + 4 张电台图片
